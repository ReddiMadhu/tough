...
exec gunicorn api.main:app \
  ...
  --graceful-timeout 30 \
  --access-logfile -
gunicorn api.main:app --worker-class uvicorn.workers.UvicornWorker --bind 0.0.0.0:$PORT --workers 2 --timeout 600 --keep-alive 65 --graceful-timeout 30 --access-logfile -
